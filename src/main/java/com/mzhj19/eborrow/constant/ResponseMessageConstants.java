package com.mzhj19.eborrow.constant;
...
public class ResponseMessageConstants {
    ...
    // not matched
    public final static String CONFIRMED_PASSWORD_NOT_MATCHED = "CONFIRMED PASSWORD NOT MATCHED!";

    // already exists

    public final static String EMAIL_ALREADY_EXISTS = "EMAIL ALREADY EXISTS!";
    public final static String MOBILE_NO_ALREADY_EXISTS = "MOBILE NO ALREADY EXISTS!";
